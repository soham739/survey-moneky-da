...
dataset_melt = dataset_modified.melt(id_vars=id_vars,value_vars=value_vars,var_name='Questions+Subquestions',value_name='Answers' )
dataset_melt
#Main dataset
...
# %%
questions = questions.drop(columns=["Raw Question","Raw Subquestion","Subquestions"])
questions
#Questions dataset
